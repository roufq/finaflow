...
<div class="max-w-3xl mx-auto space-y-10">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold tracking-tight text-slate-900">New Category</h1>
            <p class="text-sm font-medium text-slate-500">Define a new classification for your financial flows.</p>
        </div>
        ...
        <form action="{{ route('categories.store') }}" method="POST" class="space-y-8">
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="e.g. Wellness, SaaS, Groceries" required
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <select id="type" name="type" required
                            ...
                            <option value="income" {{ old('type') == 'income' ? 'selected' : '' }}>Income (Inflow)</option>
                            <option value="expense" {{ old('type', 'expense') == 'expense' ? 'selected' : '' }}>Expense (Outflow)</option>
                        </select>
