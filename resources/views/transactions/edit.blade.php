...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Edit Transaksi</h1>
    </div>

    <div class="card shadow-sm border-0 mb-4" style="border-radius: 12px;">
        <div class="card-header bg-white py-3 border-0">
            <h6 class="m-0 font-weight-bold text-primary">Pembaruan Riwayat Transaksi</h6>
        </div>
        <div class="card-body px-4 pb-4">
            <form action="{{ route('transactions.update', $transaction) }}" method="POST">
                ...
                <div class="d-flex justify-content-end" style="gap: 12px;">
                    ...
                    <button type="submit" class="btn btn-primary px-5 font-weight-bold shadow-sm" style="background-color: #3b82f6;">Perbarui Transaksi</button>
                </div>
            </form>
        </div>
    </div>
