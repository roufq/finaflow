...
<div class="container-fluid py-4">
    <div class="mb-4">
        <h1 class="h3 mb-1 text-gray-800 font-weight-bold">Edit Pengaturan Keuangan</h1>
        <p class="text-muted small">Perbarui konfigurasi profil mata uang Anda.</p>
    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control form-control-modern" id="label" name="label" 
                                        placeholder="Contoh: Tabungan Utama" value="{{ old('label', $setting->label) }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-4">
