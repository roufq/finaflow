...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Buat Integrations Bank Baru</h1>
    </div>

    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form Add Integrations Bank</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('bank-integrations.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div id="api-settings" class="form-group" style="display: none;">
                    ...
                    <small class="form-text text-muted">
                        Masukkan kredensial API dari bank Anda untuk integrations otomatis.
                    </small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="notes" id="notes" class="form-control" rows="3"
                              placeholder="Notes tambahan tentang integrations ini">{{ old('notes') }}</textarea>
                </div>
