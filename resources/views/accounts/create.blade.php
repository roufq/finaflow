...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold tracking-tight text-slate-900">Add Account</h1>
            <p class="text-sm font-medium text-slate-500">Configure a new financial portal to track your assets or liabilities.</p>
        </div>
    ...
    <div class="rounded-3xl bg-white p-8 shadow-premium ring-1 ring-slate-100">
        <form action="{{ route('accounts.store') }}" method="POST" class="space-y-8" x-data="{ accountType: '{{ old('type') }}' }">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. Personal Savings" required
                ...
                <!-- Initial Balance -->
                <div class="space-y-2">
                    <label class="text-[10px] font-bold uppercase tracking-widest text-slate-400 ml-1">Opening Balance *</label>
                    <div class="relative">
                        <span class="currency-symbol absolute left-5 top-1/2 -translate-y-1/2 text-sm font-extrabold text-slate-400">Rp</span>
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="bank_name" value="{{ old('bank_name') }}" placeholder="e.g. Morgan Stanley"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="account_number" value="{{ old('account_number') }}" placeholder="XXXX-XXXX-XXXX"
                ...
                <div class="space-y-2">
                    ...
                    <input type="date" name="opening_date" value="{{ old('opening_date', date('Y-m-d')) }}"
                           class="w-full rounded-2xl border-none bg-slate-50 px-5 py-3.5 text-sm font-semibold text-slate-900 ring-1 ring-slate-200 transition-all focus:ring-2 focus:ring-primary-500/20">
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <textarea name="notes" rows="3" placeholder="Context for this financial channel..."
                          class="w-full rounded-2xl border-none bg-slate-50 px-5 py-4 text-sm font-medium text-slate-900 ring-1 ring-slate-200 transition-all placeholder:text-slate-300 focus:ring-2 focus:ring-primary-500/20">{{ old('notes') }}</textarea>
            </div>
