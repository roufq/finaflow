...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Integrasi Telegram Bot</h1>
    </div>
                ...
                <div class="card-header bg-gradient-primary py-4 border-0" style="background: linear-gradient(135deg, #0088cc 0%, #00acee 100%);">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="text-white-50 mb-0 small">Catat transaksi lebih cepat via Telegram</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-7">
                            ...
                            <p class="text-muted small leading-relaxed">
                                Fitur ini memungkinkan Anda untuk mencatat pengeluaran harian langsung melalui aplikasi Telegram tanpa perlu membuka dashboard FinaFlow. 
                                Cukup kirim pesan singkat, dan sistem AI kami akan memprosesnya secara otomatis.
                            </p>
                            <ul class="list-unstyled small text-muted">
                                <li class="mb-2"><i class="fas fa-check-circle text-success mr-2"></i> Gratis & Cepat</li>
                                <li class="mb-2"><i class="fas fa-check-circle text-success mr-2"></i> Deteksi Kategori Otomatis</li>
                        ...
                        <div class="col-md-5 text-center p-3 bg-light rounded" style="border: 1px dashed #cbd5e1;">
                            ...
                            <div class="text-left bg-white p-2 rounded shadow-sm" style="font-family: monospace;">
                                <span class="text-info font-weight-bold">Bot:</span> 💰 Transaksi Berhasil!
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-top pt-4">
                        ...
                        @elseif($user->telegram_id)
                            <div class="d-flex align-items-center p-3 bg-success-light rounded" style="background-color: #f0fdf4; border: 1px solid #bbf7d0;">
                                ...
                                <div class="ml-auto d-flex" style="gap: 10px;">
                                    ...
                                    <form action="{{ route('integrations.telegram-bot.disconnect') }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin memutuskan koneksi Telegram?')">
                                        @csrf
                        ...
                        @else
                            <div class="text-center py-4 px-3 bg-light rounded" style="border: 1px solid #e2e8f0;">
                                <p class="text-muted mb-4">Akun Anda belum terhubung dengan bot Telegram.</p>
                                ...
                                <div class="mt-4 pt-3 border-top">
                                    ...
                                    <div class="bg-white p-2 border rounded small text-left">
                                        1. Buka Telegram & cari: <strong>@ {{ $telegramBotName }}</strong><br>
                                        2. Kirim pesan: <code>/start {{ $telegramToken }}</code>
                                    </div>
                                </div>
                            </div>
                        @endif
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('integrations.telegram-bot.settings') }}" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <small class="text-muted" style="font-size: 0.75rem;">Gunakan jika server Anda tidak bisa menerima koneksi langsung dari Telegram.</small>
                        </div>
                        <button type="submit" class="btn btn-primary btn-sm btn-block rounded-pill">Simpan Pengaturan</button>
                    </form>
                ...
                <div class="card-body">
                    <div class="timeline small">
                        ...
                        <div class="d-flex mb-4">
                            ...
                            <div>
                                <h6 class="font-weight-bold mb-1">Kirim Transaksi</h6>
                                <p class="text-muted mb-0">Ketik [Nama Item] spasi [Nominal]. Contoh: "Bensin 20000".</p>
                            </div>
                        </div>
                        <div class="d-flex mb-4">
                            <div class="mr-3">
                            ...
                            <div>
                                <h6 class="font-weight-bold mb-1">Multi-Akun</h6>
                                <p class="text-muted mb-0">Tambahkan nama akun untuk memilih sumber dana. Contoh: "Bensin 20000 Mandiri".</p>
                            </div>
                        </div>
                    </div>
                    
                    <div class="alert alert-info border-0 shadow-sm mt-3 py-2 px-3 small">
                        <i class="fas fa-info-circle mr-1"></i> Bot akan menggunakan <strong>Akun Utama Aktif</strong> jika nama akun tidak disertakan.
                    </div>
                </div>
            </div>
