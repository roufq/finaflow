...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Debts</h1>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <small class="text-muted">{{ number_format($debt->payoff_progress, 1) }}% paid</small>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <h5 class="text-gray-500">Belum ada debts</h5>
                    <p class="text-gray-500">Mulai catat debts pertama Anda untuk melacak pembayaran</p>
                    <a href="{{ route('debts.create') }}" class="btn btn-primary">Add Debt Pertama</a>
                </div>
            </div>
        </div>
        @endforelse
        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Ringkasan Debts</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="text-center">
                                ...
                                <small class="text-muted">Debts Aktif</small>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-center">
                                <h4 class="text-success">{{ $debts->where('status', 'paid_off')->count() }}</h4>
                                <small class="text-muted">Sudah Paid</small>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-center">
                        ...
                        <div class="col-md-3">
                            <div class="text-center">
                                ...
                                <small class="text-muted">Total Debt Aktif</small>
                            </div>
                        </div>
                    </div>
                </div>
