...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <p class="text-muted mb-0 small">{{ ucfirst($module->category) }} · {{ ucfirst($module->difficulty) }} · {{ $module->estimated_time }} min</p>
        </div>
                ...
                <div class="card-body">
                    @forelse($relatedModules as $related)
                        <div class="mb-3">
                            ...
                            <small class="text-muted">{{ ucfirst($related->difficulty) }} · {{ $related->estimated_time }} min</small>
                        </div>
                        @if(!$loop->last)
                            <hr>
                        @endif
