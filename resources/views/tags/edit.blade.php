...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted small">
                        Tags will appear exactly like this on tagged transactions.
                    </p>
                </div>
            </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-success">Tag Statistics</h6>
                </div>
                <div class="card-body">
                    ...
                    <hr>
                    <p class="text-muted small">
                        This tag has been used on {{ $tag->getTransactionsCount() }} transactions.
                        Changing the tag name won't affect existing transactions.
                    </p>
                </div>
            </div>
        </div>
